  ...
  return (
    <div className="w-full max-w-2xl flex flex-col items-center gap-4">
      ...
      <div className="w-full relative group">
        ...
        <div className="relative flex items-center bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-2 shadow-2xl ring-1 ring-white/5">
          ...
          <input
            ...
            className="w-full bg-transparent border-none text-white text-lg placeholder-gray-500 focus:ring-0 px-4 py-3"
            disabled={isLoading}
          />
        </div>
      </div>
